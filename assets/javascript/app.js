$(document).ready(function () {
    var apiKey = "5ebb2b59e5ef20db17d0d8f2f6e72481";
    ...
    $.ajax({
        ...
        headers: {
            "x-app-id": "9d90687a",
            "x-app-key": "5ebb2b59e5ef20db17d0d8f2f6e72481",
            "x-remote-user-id": 0
        },
        "query": "chicken",
        method: "POST"
    ...
    $(document).on("click", ".choices", function() {
        ...
        var recipes = $(this).attr("data-recipe");
        console.log(recipes);


        // debugger;
		var queryURL = "https://www.food2fork.com/api/get?key=5ebb2b59e5ef20db17d0d8f2f6e72481&rId=" + recipes + "&sort=r";
        console.log(queryURL)
...
// debugger;
            var recipeImg = parsedResponse.recipe.image_url;
            var ingredients = parsedResponse.recipe.ingredients;

			for(var i = 0; i < ingredients.length; i++) {
                var recipes = $("<p>").text(ingredients[i]);
                var image = $("<img>");
                image.attr({"src": recipeImg});
                recipes.append(image);
				$("#food-data1").append(recipes);
			};
		});
    });
